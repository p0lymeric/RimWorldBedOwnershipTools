...
set "RW_MANAGED_ROOT=C:\Games\RimworldDev\Rimworld1.6.4566"
...
set "CSC_REFERENCES=%CSC_REFERENCES%,%RW_MANAGED_ROOT%\netstandard.dll"
...
@echo on
cd ..\..
csc -target:library -out:1.6\Assemblies\BedOwnershipTools.dll -define:RIMWORLD__1_6 -reference:%CSC_REFERENCES% %CSC_INPUTS%
@echo off
